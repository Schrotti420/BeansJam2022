    ...
    public class AnimationGenerator : EditorWindow
    {
        ...
        void GenerateAnimation()
        {
            ...
            if (workingInfo != null)
            {
                ...
                workingInfo.info.velocity[workingInfo.workingFrame] = workingInfo.animator.rootPosition;
                workingInfo.info.angularVelocity[workingInfo.workingFrame] = workingInfo.animator.rootRotation;// * Mathf.Rad2Deg;
            ...
            int animationIndex)
        {
            ...
            for (int i = 0; i != stateMachine.states.Length; ++i)
            {
                ...
                if (bake.info.rootMotion)
                {
                    ...
                    bake.info.angularVelocity = new Quaternion[bake.info.totalFrame];
                }
            ...
            foreach (var obj in aniInfo)
            {
                ...
                if (info.rootMotion)
                {
                    ...
                    for (int i = 0; i != info.velocity.Length; ++i)
                    {
                        ...
                        writer.Write(info.angularVelocity[i].w);
                    }
                }
