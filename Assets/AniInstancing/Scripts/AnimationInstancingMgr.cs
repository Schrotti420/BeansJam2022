...
//                 vertexCache.currentInstancingIndex = 0;
        ...
        private void ApplyRootMotion(AnimationInstancing instance)
        {
            ...
            Quaternion angularVelocity = Quaternion.Lerp(info.angularVelocity[preSampleFrame], info.angularVelocity[nextSampleFrame], instance.curFrame - preSampleFrame);
...
// #else
                instance.worldTransform.localPosition = velocity;//localPosition;
                instance.worldTransform.localRotation = angularVelocity; //localQuaternion;
//#endif
            }
        }
